    ...
    <>
      <header className="iptv-header">
        <div className="iptv-shell iptv-header-inner">
          ...
          <div className="iptv-header-actions"><a className="iptv-login" href="#player">Sign in</a><a className="iptv-button iptv-button-small" href="#player">Open player <ChevronRight size={15} /></a></div>
      ...
      <main id="top">
        <section className="iptv-hero">
          ...
          <div className="iptv-shell iptv-hero-grid">
            <div className="iptv-hero-copy"><span className="iptv-kicker"><Sparkles size={14} /> Your channels. Your way.</span><h1>Every stream,<br /><em>beautifully simple.</em></h1><p>Figimi IPTV Player brings your live TV, movies, and playlists into one calm, fast player that feels right on every screen.</p><div className="iptv-hero-actions"><a className="iptv-button" href="#player"><CirclePlay size={18} /> Try the player</a><a className="iptv-text-link" href="#how-it-works">See how it works <ChevronRight size={16} /></a></div><div className="iptv-proof"><span><Check size={15} /> No subscription required</span><span><LockKeyhole size={15} /> Privacy-first</span></div></div>
      ...
      <footer className="iptv-footer"><div className="iptv-shell"><div className="iptv-footer-grid"><div><a className="iptv-brand" href="#top"><span className="iptv-brand-mark"><Radio size={18} /></span><span>Figimi <b>IPTV</b></span></a><p>A calmer way to watch the channels you already love.</p></div><nav><b>Product</b><a href="#features">Features</a><a href="#devices">Devices</a><a href="#player">Open player</a></nav><nav><b>Learn</b><a href="#how-it-works">How it works</a><a href="#faq">FAQ</a><a href="#playlist">Get started</a></nav><nav><b>Figimi</b><a href="mailto:hello@figimi.com">Contact</a><a href="#faq">Privacy</a><a href="#top">Back to top ↑</a></nav></div><div className="iptv-footer-bottom"><span>© {new Date().getFullYear()} Figimi. Built for better watching.</span><span>Figimi does not provide or host channel content.</span></div></div></footer>
    </>
  );
}
