    ...
    <footer className="site-footer">
      <div className="shell"><AdSlot slot="footer" className="footer-ad" />
        <div className="footer-grid"><div><strong>{siteConfig.name}</strong><p>Figimi is a collection of free file, text, document and image tools. Our drawing and color palette creator is fast and free. Uploads are deleted in an hour. Count your words, convert files or extract text from images.</p></div>
          ...
          <nav aria-label="Footer legal"><strong>Legal</strong><Link href="/privacy-policy">Privacy Policy</Link><Link href="/terms-of-service">Terms of Service</Link><CookiePreferences /></nav>
